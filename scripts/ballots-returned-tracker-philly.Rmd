...
<br>
<br>
<h5>Across Pennsylvania, `r total_pct_returned`% of mail ballots issued have been returned. Among registered Democrats, that rate is `r pct_returned_d`%, and among registered Republicans, it's `r pct_returned_r`%.</h5>
<br>
<br>
