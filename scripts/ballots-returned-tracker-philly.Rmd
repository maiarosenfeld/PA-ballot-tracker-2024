...
<br>Voters might use a provisional ballot if they are not on the voter rolls, don't have required identification, returned a mail ballot with a disqualifying flaw or requested a mail ballot but did not return it.
<br>
...
<br>
After this period, voters can check if their provisional ballot was counted by searching <a href="https://www.pavoterservices.pa.gov/Pages/ProvisionalBallotSearch.aspx">here</a>.
</h5>
