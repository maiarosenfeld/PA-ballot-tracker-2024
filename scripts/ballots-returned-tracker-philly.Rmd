...
ballots_clean <- ballots %>% 
  select(`CountyName`, `Total Applications Approved`,`Total Ballots Returned`, `Dem Applications Approved`, `Rep Applications Approved`, `Oth Applications Approved`) %>%  #select only the columns we need
