...
ballots_clean <- ballots_clean %>% select(`Ballot Applications Approved`, `Ballots Returned`, `Democratic Applications Approved`,`Republican Applications Approved`,`Other Applications Approved`,`Democratic Ballots Returned`,`Republican Ballots Returned`,`Other Ballots Returned`,`Percent Returned`)  # drop duplicate columns
