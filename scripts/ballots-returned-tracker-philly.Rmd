...
ballots_clean <- ballots %>% 
  ...
  select(`Total Applications Approved`, `Total Ballots Returned`, `Democratic Applications Approved`,`Republican Applications Approved`,`Other Applications Approved`,`Democratic Ballots Returned`,`Republican Ballots Returned`,`Other Ballots Returned`,`Percent Returned`))  # drop duplicate columns
