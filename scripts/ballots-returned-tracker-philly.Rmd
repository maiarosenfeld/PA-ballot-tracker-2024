...
if (total_ballots_returned_d > 1000000) {
  total_ballots_returned_d_display = paste(sep="", as.character(round((total_ballots_returned_d/1000000), digits=2)), " M")
} else {
  total_ballots_returned_d_display = paste(sep="", as.character(round((total_ballots_returned_d/1000), digits=2)), " K")
}

if (total_ballots_returned_r > 1000000) {
  total_ballots_returned_r_display = paste(sep="", as.character(round((total_ballots_returned_r/1000000), digits=2)), " M")
} else {
  total_ballots_returned_r_display = paste(sep="", as.character(round((total_ballots_returned_r/1000), digits=2)), " K")
}
...
<iframe title="Philadelphia mail ballots with deficiencies" aria-label="Table" id="datawrapper-chart-a81Nx" src="https://datawrapper.dwcdn.net/a81Nx/1/" scrolling="no" frameborder="0" style="border: none;" width="600" height="1412" data-external="1"></iframe>
<br>
<br>
<h2>See Montgomery County mail ballots with issues <a href="https://www.montgomerycountypa.gov/DocumentCenter/View/45181/Ballots-with-Deficiencies?bidId=" target="_blank">here</a>.</h2>
<br>
<br>
<br>
