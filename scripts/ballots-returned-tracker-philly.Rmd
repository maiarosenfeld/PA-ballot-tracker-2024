...
<br>
<br>
<h5>Across Pennsylvania, </h5><body>total_pct_returned%</body><h5> of mail ballots issued have been returned. Among registered Democrats, that rate is <body>pct_returned_d%</body>, and among registered Republicans, it's <body>pct_returned_r%</body><h5>.</h5>
<br>
<br>
