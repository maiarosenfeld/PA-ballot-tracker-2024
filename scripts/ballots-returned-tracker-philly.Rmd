...
ballots_clean_total <- ballots_clean %>% 
  filter(`CountyName` == 'TOTAL') #select only TOTAL row

ballots_clean <- ballots_clean %>% 
  filter(`CountyName` != 'TOTAL')  #filter out only TOTAL row

write.csv(ballots_clean, "ballots_clean.csv", row.names = FALSE)
write.csv(ballots_clean_total, "ballots_clean_total.csv", row.names = FALSE)
